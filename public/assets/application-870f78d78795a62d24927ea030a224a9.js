...
(function() {
  $.unobtrusive = function(callback) {
    return $(document).bind('activate-unobtrusive-javascript', function(event, root) {
  ...
  $.fn.activateUnobtrusiveJavascript = function() {
    return this.each(function() {
      return $(document).trigger('activate-unobtrusive-javascript', this);
    });
  };

  $(document).ready(function() {
    return $(document).activateUnobtrusiveJavascript();
  });
  ...
  $.unobtrusive(function() {
    ...
    return $('a.dropdown-toggle, .dropdown-menu a').on('touchstart', function(e) {
      return e.stopPropagation();
    });
  });
...
(function() {
  $.fn.flash = function(options) {
    ...
    target = $(this);
    if (options.start) {
      target.addClass(options.start);
    }
    return $.when(target.delay(1)).done(function() {
      target.addClass('af-flashable');
      return $.when(target.delay(options.duration)).done(function() {
        if (options.start) {
          target.removeClass(options.start);
        }
        if (options.end) {
          target.addClass(options.end);
        }
        return $.when(target.delay(2 * options.duration)).done(function() {
          if (options.end) {
            target.removeClass(options.end);
          }
          target.removeClass('af-flashable');
          if (options.after) {
            return options.after(target);
          }
        });
      });
    });
...
(function() {
  $(document).ajaxComplete(function(event, request) {
    ...
    return $('#flashes').activateUnobtrusiveJavascript();
  });

}).call(this);
(function() {
  $.unobtrusive(function() {
    return $('.js-fading-errors').each(function() {
      var that;
      that = $(this).find('.field_with_errors');
      that.closest('.control-group').addClass('error');
      return that.find('textarea').on('focus', function() {
        var control;
        control = $(this).closest('.control-group');
        control.removeClass('error');
        return control.find('.help-block.error').fadeOut();
      });
    });
  });
...
(function() {
  $.unobtrusive(function() {
    return $('.af-mutable-content :input').bind('focus', function() {
      return $(this).closest('.af-mutable-content').addClass('focused');
    }).bind('blur', function() {
      return $(this).closest('.af-mutable-content').removeClass('focused');
    });
  });
...
(function() {
  $.unobtrusive(function() {
    var pusher_key, user_id;
    pusher_key = $('body').data('pusher-key');
    user_id = $('body').data('user-id');
    if (!$('html').data('pusher-loaded')) {
      return $.getScript("https://d3dy5gmtp8yhk7.cloudfront.net/2.0/pusher.min.js", function() {
        var channel, pusher;
        pusher = new Pusher(pusher_key);
        channel = pusher.subscribe("user-" + user_id);
        channel.bind('echo', function(data) {
          return console.log(data);
        });
        channel.bind('notification', function(data) {
          var container;
          container = $('#flashes');
          return container.prepend(data.html);
        });
        ...
        channel.bind('update-user', function(data) {
          var n, node, value;
          node = $("#current_user");
          if (value = data.karma) {
            ...
            n.text(value);
            n.flash({
              start: 'af-flashable-burnin',
              end: 'af-flashable-burnout'
            });
          }
        ...
        return $('html').data('pusher-loaded', true);
      });
    }
  });
...
(function() {
  $.unobtrusive(function() {
    $('[data-tooltip-url]').on('mouseover', function() {
      var url;
      url = $(this).attr('data-tooltip-url');
      this.clearForTooltip = function() {
        $(this).tooltip('destroy');
        $(this).removeAttr('data-original-title');
        $(this).removeAttr('title');
        return $(this).addClass('af-loading');
      };
      ...
      return $.ajax({
        ...
        success: function(data) {
          ...
          if ($(this).data('should-show')) {
            return $(this).tooltip('show');
          }
        },
        complete: function() {
          return $(this).removeClass('af-loading');
        }
      });
    });
    return $('[data-tooltip-url]').on('mouseout', function() {
      return $(this).data('should-show', false);
    });
  });
...
(function() {
  $.unobtrusive(function() {
    return $('[data-uploader]').each(function() {
      var file_template, parent, refresh_endpoint, refresh_target, upload_endpoint, uploader, uploader_template;
      ...
      return uploader = new qq.FineUploader({
        ...
        callbacks: {
          onComplete: function(id, name, data) {
            ...
            if (data.success) {
              return $(this).find('.qq-upload-list li').eq(id).fadeOut();
            }
          }
        }
      });
...
(function() {
  ...
  $(document).on('page:fetch', function() {
    return $('[data-barberpole]').addClass('af-barberpole');
  });
  ...
  $(document).ready(function() {
    ...
    return $(document).ajaxComplete(function() {
      return $('[data-barberpole]').removeClass('af-barberpole');
    });
  });
